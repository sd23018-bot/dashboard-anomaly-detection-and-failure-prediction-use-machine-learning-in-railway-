    ...
    if st.sidebar.button("🚀 Find Best Prediction Model"):
        ...
        with st.spinner("Running prediction models..."):
            ...
            if best_reg is not None:
                ...
                comp_df = pd.DataFrame.from_dict(results, orient='index', columns=['R²']).sort_values('R²', ascending=False)
                st.sidebar.dataframe(comp_df)
            else:
                st.sidebar.error("All models failed.")
else:
...
# --------------------------------------------------------------------------
# MAIN PAGE — FORECAST CHART & ANOMALY EXPLANATION TABLE
# --------------------------------------------------------------------------
