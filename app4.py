...
def compute_asoi_detailed(scores, percentile=5):
    ...
    # 2. Overlap coefficient for two normal distributions
        ...
        with st.spinner("Running all models..."):
            for m in ANOMALY_MODELS:
                try:
                    ...
                    # Compute ASOI with full details
...
if st.session_state.get("anomaly_comparison") is not None:
    with st.expander("📊 Model Performance Comparison (ASOI)", expanded=True):
        st.dataframe(
