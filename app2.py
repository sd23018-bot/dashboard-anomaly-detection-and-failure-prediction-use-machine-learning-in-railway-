...
# ==========================================================================
# TAB 3 — FORECAST & FAILURE ZONE (Trend Window removed)
# ==========================================================================
with tab3:
    if st.session_state.det_result is None or "anomaly" not in st.session_state.det_result.columns:
        ...
        det = st.session_state.det_result
        fc1, fc2 = st.columns(2)  # now only two columns
        with fc1:
        ...
        if run_forecast:
            ...
            # Trend window is now fixed to 100 (you can change this constant if you like)
